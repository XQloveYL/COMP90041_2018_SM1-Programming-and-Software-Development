...
public class Nimsys {
    ...
    private void readCommand(String command) {
        try {
            ...
            } else if (keyword.equals("adddummyaiplayer")) {
                addPlayer(stringSplit[1], "dummy");
        ...
        try {
            ...
            if (findPlayer(username) != -1) {
                ...
                if (playerCount < MAX_NUM_OF_PLAYERS) {
                    ...
                    } else if (playerType.equals("dummy")) {
                        adddummyplayer(username, familyName, givenName);
                    }
                }
            }
        }
    ...
    private void adddummyplayer(String username, String familyName, String givenName) {
        playerArray[playerCount] = new DummyAI(username, familyName, givenName);
        playerCount++;
    }
