...
public class Nimsys {
    ...
    private void readCommand(String command) {
        try {
            ...
            if (keyword.equals("addplayer")) {
                ...
                if (stringSplit.length == 1) {
                    rankings(DESC, command);
                } else {
                    rankings(stringSplit[1], command);
                }
            } else {
    ...
    /**
     * Check the correctness of the number of arguments.
     * @param argsNum number of arguments input
     * @param minArgsNum number of the minimum number arguments should input
     * @throws InvalidNumOfArgsException an exception indicates arguments number is invalid
     */
    ...
    /**
     * Sort the player array by win ratio in assigned sort order.
     * Ties be resolved by sorting on usernames alphabetically.
     * @param sortOrder a String indicates the sort order, ascending or descending.
     */
    private void sortByWinRatio(String sortOrder) {
     ...
     * @param sortOrder a string indicates the sort order
     */
    private void rankings(String sortOrder, String invalidCommand)
    ...
    /**
     * Print out the original type game information.
    ...
    /**
     * Start the declared type of game
    ...
    /**
     * Start the original type game
     * @param gameInfo information of a game
     */
    ...
    /**
     * Print out the advanced type game information.
     * @param initialStones the initial stones number
     * @param player1 the first player
     * @param player2 the second player
     */
    ...
    /**
     * Store the statics and then exit the Nimsys program
     */
    private void exit() {
    ...
    /**
     * Read the statics from the input file
    ...
    /**
     * Write the statics in an output file
     * @param fileName a String for file name
     */
